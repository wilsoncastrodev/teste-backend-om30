...
Route::prefix('v1')->group(function () {
    ...
    Route::get('patients/paginate/{length}', [PatientController::class, 'paginate']);
    Route::get('patients/search/{query}', [PatientController::class, 'searchPatient']);
    Route::get('patients/search/{query}/paginate/{length}', [PatientController::class, 'searchPatientPaginate']);
